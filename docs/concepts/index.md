...
- [**BIOSSettingsSet**](/concepts/biossettingsset): Handles creation of multiple BIOSSettings by selecting physical servers through labels.
- [**BIOSVersion**](/concepts/biosversion): Handles upgrading the BIOS version on the physical server's BIOS.
- [**BIOSVersionSet**](/concepts/biosversionset): Handles creation of multiple BIOSVersion by selecting physical servers through labels.
